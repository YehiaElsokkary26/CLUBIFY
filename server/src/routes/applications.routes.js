...
const { clubApplicationValidator, volunteerApplicationValidator, selectSlotValidator } = require('../validators/applications.validators')
...
router.post('/:id/select-slot', auth, requireRole('student'), selectSlotValidator, validate, c.selectSlot)
